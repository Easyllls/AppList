...
<summary>🎭 <strong>Magisk Module（大部分已兼容KernelSU、APatch）</strong></summary>
- [标题](链接)：
- [标题](链接)：
- [标题](链接)：
- [标题](链接)：
...
- [浏览器增强](https://pan.baidu.com/s/1l9nfpBGGSPwg1JeUE3HXEw?pwd=6666 )：
  - ChromePie：给Chrome浏览器加个Pie菜单
  - BetterVia：via浏览器解除白名单限制自己更多增强功能
  - EdgeX：edge浏览器界面优化与功能增强，调用第三方下载器等
- [Activity启动链管理](https://pan.baidu.com/s/1Xq4s4ofM5EJmifkVQeG-hQ?pwd=6666 )：拦截三方App跳转另一个三方App，激活模块后当存在三方app启动另一个三方App时，系统会弹出一个App启动对话框，同时也可以设置自定义允许拒绝规则。
- [标题](链接)：
- [标题](链接)：
- [标题](链接)：
- [标题](链接)：
...
- [IPTV](链接)：
  - 我的电视：电视直播
  - WebView 电视：使用 腾讯X5 WebView 开发的电视直播App
- [直播](链接)：
  - Simple Live：聚合直播软件，支持斗鱼、虎牙、抖音、哔哩哔哩
  - 纯粹直播：第三方聚合多平台直播播放器，支持哔哩哔哩/虎牙/斗鱼/快手/抖音/网易cc/M38自定义源
- [桌面](https://pan.baidu.com/s/10k75Mo9t1hyfKPIII7hfyQ?pwd=6666 )：
  - FLauncher：一个干净、可控、无广告的 Android TV 极简桌面
  - Projectivy Launcher：终极可定制启动器
  - Leanback启动器：一个第三方开源的 Google Leanback 启动器增强版
  - LM Ultimate：安卓电视 盒子桌面管理工具
  - Emotn UI：一款极简设计，极致易用的安卓电视桌面应用
- [Fluffy](链接)：一款 快速、现代的文件管理器
- [Adblocker](链接)：一款带有广告拦截器的互联网浏览器。
- [小白云盘](链接)：强大的云盘工具,支持阿里云盘，可以实现高清杜比播放,支持4K高清视频,可以边下边播。支持多账号登录，文件管理功能
- [Gemby](链接)：基于 MPV 内核的简约 Emby AndroidTV 客户端
- [标题](链接)：
- [标题](链接)：
- [标题](链接)：
- [标题](链接)：
